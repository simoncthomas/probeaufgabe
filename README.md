...
## Hot fix
It wouldn't be a correct "launch" without a hot fix, right? To be honest, it embarrasses me to admit, but I hadn't tested enough and found a bug in my code where the first number was bigger than the second. I fixed it by changing the approach (Constructive) and pushed again. So let me add another point to the list above before the launch: TESTING!